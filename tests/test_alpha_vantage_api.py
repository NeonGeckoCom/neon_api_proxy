...
class TestAlphaVantageAPI(unittest.TestCase):
    ...
    def test_get_quote_valid(self):
        ...
        self.assertIsInstance(quote["price"], str)
        self.assertEqual(quote["symbol"], VALID_COMPANY_SYMBOL)
    ...
    def test_handle_query_symbol_valid_company(self):
        ...
        self.assertIsInstance(data["region"], str)
    ...
    def test_handle_query_quote_valid_company(self):
...
# TODO: Weather cache ~15m Stock cache ~3m
